...
const VISIT_KNOWN_FIELDS = [
  'id', 'VisitTime', 'Profile', 'First Name', 'Last Name', 'Middle Name',
  'Degree', 'SalesProfile', 'RecruiterProfile', 'Picture', 'Connections',
  'Summary', 'Title', 'From', 'Company', 'CompanyProfile', 'CompanyWebsite',
  'PersonalWebsite', 'Email', 'Phone', 'IM', 'Twitter', 'Location',
  'Industry', 'My Tags', 'My Notes', 'extended', 'Birthday', 'Thumbnail',
];
...
const SCAN_KNOWN_FIELDS = [
  'id', 'ScanTime', 'Profile', 'First Name', 'Last Name', 'Middle Name',
  'Company', 'CompanyID', 'CompanyProfile', 'Title', 'Location', 'Industry',
  'Connection Degree', 'Profile URL', 'PublicProfile', 'Degree', 'Picture',
  'Thumbnail', 'Connections', 'Summary', 'SalesProfile', 'RecruiterProfile',
  'Birthday',
];
...
const ENVELOPE_KNOWN_FIELDS = [
  'userid', 'type', 'time', 'id', 'event', 'messagecontext', 'data',
];
